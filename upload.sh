...
cd ~/.cocoapods/repos/CXYPersonalPod && git pull origin master && cd - && pod repo push CasaPasswordRepositoryStore A_Category.podspec --verbose --allow-warnings --use-libraries
